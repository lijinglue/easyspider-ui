// Generated on 2014-06-18 using generator-angular-require 0.1.13
'use strict';
  ...
  grunt.initConfig({
    ...
    shell: {
      patchBower: {
        ...
        command: 'patch -p0 -N --dry-run --silent < jslib.diff 2>/dev/null && patch -p0 < jslib.diff; pushd app/bower_components/elastic.js;npm install;grunt --force;popd'
      }
    },
