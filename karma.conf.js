...
module.exports = function(config) {
  config.set({
    ...
    files: [
      {pattern: 'app/bower_components/elastic.js/dist/elastic.js', included: false },
      {pattern: 'app/bower_components/elastic.js/dist/elastic-angular-client.js', included: false },
